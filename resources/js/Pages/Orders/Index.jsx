                                    ...
                                    >
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex gap-3 pt-4 border-t border-gray-100">
                                                ...
                                                {order.payment_status ===
                                                    "pending" && (
                                                    <button className="flex items-center justify-center gap-2 px-4 py-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-semibold transition-all">
                                                        Bayar Sekarang
                                                    </button>
                                                )}
                                            </div>
